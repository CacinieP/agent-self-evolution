...
> 💡 **点评 / 启发**:工作流即代码,代码可被 MCTS 搜索——把 APE/ADAS 的"搜索"思想平移到工作流空间。证明"搜索"是横跨 prompt/架构/工作流的统一自进化原语。
>
> ⚠️ **局限 / 可质疑**:搜索算子是预定义的,本质仍是已知操作的组合优化,难发现真正新颖的工作流结构。评估指标若与真实目标有 gap,会优化到错误的工作流。
>
